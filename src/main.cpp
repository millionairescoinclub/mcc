...
const string strMessageMagic = "Millionairescoinclub Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * 33 / (365 * 33 + 8);
    return nSubsidy + nFees;
}
...
{
    RenameThread("Millionairescoinclub-loadblk");
