...
int nAnonymizeMillionairescoinclubAmount = 1000;
...
#else
    const char* pszModule = "Millionairescoinclub";
#endif
    if (pex)
        return strprintf(
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Millionairescoinclub
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Millionairescoinclub
    // Mac: ~/Library/Application Support/Millionairescoinclub
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Millionairescoinclubd.pid"));
