...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("Millionairescoinclub"))
        return false;
...
{
    // Convert Millionairescoinclub:// to Millionairescoinclub:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("Millionairescoinclub://", Qt::CaseInsensitive))
    {
        uri.replace(0, 11, "Millionairescoinclub:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Millionairescoinclub.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Millionairescoinclub.lnk
...
{
    return GetAutostartDir() / "Millionairescoinclub.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        if (!optionFile.good())
            return false;
        // Write a Millionairescoinclub.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=Millionairescoinclub\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the Millionairescoinclub app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if(fAutoStart && !foundItem) {
        // add Millionairescoinclub app to startup item list
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Millionairescoinclub-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Millionairescoinclub-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("Millionairescoinclub-Qt"));
