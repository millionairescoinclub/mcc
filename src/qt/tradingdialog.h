...
private slots:
    ...
    QString BuyMCC(QString OrderType, double Quantity, double Rate);
    QString SellMCC(QString OrderType, double Quantity, double Rate);
