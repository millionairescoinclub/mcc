...
/**
 * Split Millionaires Coin Club command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Millionaires Coin Club RPC console.") + "<br>" +
